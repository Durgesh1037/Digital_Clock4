...
function newsettime(){
        ...
        if(a==hrs)
        {
            ...
            document.querySelector("#right-inner2").style.backgroundImage="url(./sun.png)";
        }
        if(b==hrs)
        {
            document.querySelector("#right-inner1").innerText="Let's Have Some Food";
            document.querySelector("#right-inner2").style.backgroundImage="url(./spoon.png)";
        }
        if(c==hrs)
        {
            document.querySelector("#right-inner1").innerText="Let's Go For Sleep";
            document.querySelector("#right-inner2").style.backgroundImage="url(./zimage.png)";
        }
}
...
function setYourGoal() {
    ...
    if(val1 !== "")
    {
        // if (val1 == 0) {
        //     val1 = 12;
        //     msg1.innerHTML = "wakeup time :" + val1 + "am -0" + parseInt(0 + 1) + "am";
        // }
         if (val1 < 11) {
    ...
    if(val2 !== "")
    {
        // if (val2 == 0) {
        //     val2 = 12;
        //     msg2.innerHTML = "lunch time :" + val2 + "am -0" + parseInt(0 + 1) + "am";
        // }
        if (val2 < 11) {
    ...
    if(val3 !== "")
    {
        // if (val3 == 0) {
        //     val3 = 12;
        //     msg3.innerHTML = "nap time :" + val3 + "am -0" + parseInt(0 + 1) + "am";
        // }
        if (val3 < 11) {
